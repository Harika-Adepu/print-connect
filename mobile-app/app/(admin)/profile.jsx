      ...
      <ScrollView contentContainerStyle={{ padding: 20, paddingBottom: 60 }}
        ...
        <View style={{ backgroundColor: COLORS.card, borderRadius: 20, padding: 20,
          ...
          <View style={{ width: 72, height: 72, borderRadius: 36,
            backgroundColor: ADMIN_BG, alignItems: "center",
            justifyContent: "center", marginBottom: 12 }}>
            <Text style={{ fontSize: 26, fontWeight: "800", color: ADMIN_COLOR }}>
              {initials}</Text>
          </View>
          ...
          <Text style={{ fontSize: 13, color: COLORS.muted, marginTop: 4 }}>
            {user?.email}</Text>
          <View style={{ marginTop: 10, backgroundColor: ADMIN_BG,
            paddingHorizontal: 12, paddingVertical: 4, borderRadius: 999 }}>
            <Text style={{ fontSize: 11, fontWeight: "700", color: ADMIN_COLOR,
              textTransform: "uppercase", letterSpacing: 1 }}>⚙️ Administrator</Text>
          </View>
        </View>
        ...
        <View style={{ backgroundColor: COLORS.card, borderRadius: 20,
          ...
          <MenuRow emoji="📊" label="Dashboard"   onPress={() => router.push("/(admin)/dashboard")} />
          <MenuRow emoji="📨" label="Requests"    onPress={() => router.push("/(admin)/requests")} />
          <MenuRow emoji="📦" label="All Orders"  onPress={() => router.push("/(admin)/orders")} />
          <MenuRow emoji="🗂️" label="Products"   onPress={() => router.push("/(admin)/products")} />
          <MenuRow emoji="👥" label="Users"       onPress={() => router.push("/(admin)/users")} />
        </View>
